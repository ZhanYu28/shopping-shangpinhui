  ...
  <div class="order-right">
          <div class="order-content">
            ...
            <div class="orders">
              ...
              <table class="order-item" v-for="(item,index) in order.records" :key="index">
                <thead>
                  <tr>
                    <th colspan="5">
                ...
                <tbody>
                  <tr v-for="(subItem,index) in item.orderDetailList" :key="index">
                    <td width="60%">
                      <div class="typographic" >
                        <img style="width:100px;height:100px" :src="subItem.imgUrl">
                        <a href="#" class="block-text">{{subItem.skuName}}</a>
            ...
            <div class="choose-order">
              <BasePagination  :pageNo = "data.page" :pageSize="data.limit" :total="order.total" :continues="5" @changePage = "changePage" />
            </div>
          </div>
          <!--猜你喜欢-->
          <div class="like">
...
import { useStoreActions, useStoreState } from '@/store/storeMap'
export default {
    name:'MyOrder'
}
</script>
...
const {getMyOrder} = useStoreActions('myOrder',['getMyOrder'])
const {order} = useStoreState('myOrder',['order'])
